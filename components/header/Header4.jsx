  ...
  <div className={showMobileMenu === 1 ? "main-nav show-menu" :"main-nav"}>
    ...
    <ul className="menu-list">
      <li className="menu-item-has-children" onClick={() => dispatch({type: 'homeOne'})}>
        <Link href="#" className="drop-down"><a>Home</a></Link><i className="bi bi-chevron-down dropdown-icon" />
        <ul className={state.activeMenu ==='homeOne'? "sub-menu d-block": "sub-menu d-none"}>
          ...
          <li><Link href="#"><a>Home 4</a></Link></li>
          <li><Link href="/index5"><a>Home 5</a></Link></li>
        </ul>
      </li>
