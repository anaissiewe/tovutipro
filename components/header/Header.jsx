  ...
  return (
    <>
            ...
            <div className="address-card mb-5">
              <div className="content">
                ...
                <ul className="address-list">
                  <li>
                    <span>Address:</span> 21910 Casa Bay Drive
                  </li>
                  <li>
                    <span>Phone:</span> <a href="tel:+8801761456456">+1 346 673 0073</a>
                  </li>
                  <li>
                    <span>Email:</span>
                    <a href="mailto:hello@tovutipro.com"> hello@tovutipro.com</a>
                  </li>
                </ul>
              </div>
      ...
      >
          ...
          <div className="d-lg-none d-block">
            <form className="mobile-menu-form">
              <div className="input-with-btn d-flex flex-column">
                ...
                <button
                  type="submit"
                  className="g-btn btn--primary2 btn--sm"
                >
                  Search
                </button>
              </div>
        ...
        <div
          className="nav-right d-flex align-items-center gap-5"
          ...
          <>
            ...
            <div className="hotline d-xxl-flex d-none">
              ...
              <div className="hotline-info">
                <span>Messge Us</span>
                <h6>
                  <Link href="mailto:hello@tovutipro.com">hello@tovutipro.com</Link>
                </h6>
              </div>
            </div>
            <div
                className="eg-btn btn--primary2 header-btn"
            >
